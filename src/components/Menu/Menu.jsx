...
const Menu = () => {
    const carouselItemsSlide =[
        {      
             img: <img src='/src/assets/images/menuslide1.png' alt="Background Cerveza"/>,
        
       },
        {      
             img: <img src='/src/assets/images/menuslide2.png' alt="Background Cerveza"/>,
